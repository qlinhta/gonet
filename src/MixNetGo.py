...
for i in range(1, epochs + 1):
    ...
    if (i % 10 == 0):
        ...
        model.save(
            f"models/MixNet_{i}_{epochs}_{batch}_{learning_rate}_{N}_{dropout_rate}_val_{val[3]:.2f}.h5")
        ...
        plt.tight_layout()
        plt.savefig(
            f"figures/MixNet_{i}_{epochs}_{batch}_{learning_rate}_{N}_val_{val[3]:.2f}.pdf")
        plt.close()
